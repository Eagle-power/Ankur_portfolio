...
export default function Skills() {
  ...
  const repeated = [...skillsIcon, ...skillsIcon];
  ...
  return (
    ...
    >
      ...
      <motion.h2
        className="text-4xl mt-5 sm:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#1cd8d2]  via-[#00df8f] to-[#302b63] z-10"
