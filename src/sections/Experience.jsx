...
const experiences = [
  {
    ...
    company: "Starting Point Solution , Trier - Germany (Remote)",
    duration: "June - Oct",
    description:
      "Built high-performance apps, integrated AI features, improved engagement by 10%.",
  },
  {
    role: "Lead Developer (Skill Share Hub)",
    company: "Project : Skill Share Hub",
    duration: "2024",
    description: "Gained hands-on web development experience. Architected a complex LMS -  SaaS application from scratch. Designed the MongoDB schema, built RESTful APIs, and implemented JWT authentication.",
  },
  {
    role: "Lead Developer (Team Project)",
    company: "Project : Multi Store Inventory Management system",
    duration: "2025",
    description:
      "Architected a complex SaaS solution managing stock across multiple branches. Implemented real-time data syncing, role-based access control (RBAC), and advanced analytics dashboards.",
  },
];
